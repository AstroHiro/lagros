...
if __name__ == "__main__":
    ...
    nmpc.scp()
    dtc0_scp = time.time()-tc0
    np.save("data/leo/sim/scp/XXds.npy",nmpc.XXds)
    np.save("data/leo/sim/scp/UUds.npy",nmpc.UUds)
    np.save("data/leo/sim/scp/x0s.npy",nmpc.x0s)
    np.save("data/leo/sim/scp/xfs.npy",nmpc.xfs)
    dtc0_scp = 100
    XXds = np.load("data/leo/sim/scp/XXds.npy")
    UUds = np.load("data/leo/sim/scp/UUds.npy")
    x0s = np.load("data/leo/sim/scp/x0s.npy")
    xfs = np.load("data/leo/sim/scp/xfs.npy")
    
    this,dthis,Xshis,Ushis,ueffs,idx_fin,Nends = nmpc.nmpc_simulation(dover,XXds,UUds,dtc0_scp,x0s,xfs)
    """
    ...
    for k in range(10):
        for dover in dovers:
            ...
            while len(thiss) < Ndata:
                ...
                np.save("data/leo/sim/thiss_"+str(k)+str(dover*10)+".npy",np.array(thiss))
                np.save("data/leo/sim/dthiss_"+str(k)+str(dover*10)+".npy",np.array(dthiss))
                np.save("data/leo/sim/Xshiss_"+str(k)+str(dover*10)+".npy",np.array(Xshiss))
                np.save("data/leo/sim/Ushiss_"+str(k)+str(dover*10)+".npy",np.array(Ushiss))
                np.save("data/leo/sim/ueffss_"+str(k)+str(dover*10)+".npy",np.array(ueffss))
                np.save("data/leo/sim/idx_fins_"+str(k)+str(dover*10)+".npy",np.array(idx_fins))
                np.save("data/leo/sim/Nendss_"+str(k)+str(dover*10)+".npy",np.array(Nendss))
                np.save("data/leo/sim/x0ss_"+str(k)+str(dover*10)+".npy",np.array(x0ss))
                np.save("data/leo/sim/xfss_"+str(k)+str(dover*10)+".npy",np.array(xfss))
                i += 1
        
    nmpc = NMPC(Nobs,Nsc)
    this,dthis,Xshis,Ushis,ueffs,idx_fin,Nends = nmpc.nmpc_simulation(dover=0.3,final=1)
